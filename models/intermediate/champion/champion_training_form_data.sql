...
SELECT
    ...
    CASE
        ...
        ELSE
            ...
            - LENGTH(REPLACE(TRIM(data -> 'form' -> 'champion_training_details' ->> 'champion_village_CHR'), ' ', ''))
            + 1
    ...
    data -> 'form' -> 'champion_training_details' ->> 'start_date_CHT' AS start_date, -- TODO: cleanup the date format
